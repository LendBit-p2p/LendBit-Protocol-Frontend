...
export default function BorrowAllocationPage() {
    ...
    return (
        <div className="bg-black rounded-md p-2 font-[family-name:var(--font-montserrat)] text-white">
            ...
            <Link href={"/successful"} className="font-[family-name:var(--font-montserrat)] my-4 px-4 cursor-pointer">
                <Btn
                    text={"Borow"}
