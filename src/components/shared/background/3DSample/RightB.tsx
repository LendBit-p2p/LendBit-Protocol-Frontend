...
export const RightB = () => {
    return (
        <div
          className="absolute right-0 top-1/2 w-1/4 h-full transform -translate-y-1/2 flex justify-start items-center overflow-hidden"
          style={{
        ...
        >
            <svg
                ...
                style={{
                    ...
                    transformOrigin: "left", // Makes the transformation occur from the center
                }}
